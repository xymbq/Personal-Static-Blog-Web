var dateTime = new Date();
	...
	var currentdate = year + "-" + month + "-" + day + " " + hh + ":" + mm + ":" + ss;
layui.use(['element', 'jquery', 'form', 'layedit'], function () {
    ...
    form.on('submit(formReply)', function (data) {
        ...
        setTimeout(function () {
            ...
            var html = '<div class="comment-child"><img src="../img/user.png"alt="回复"/><div class="info"><span class="username">游客回复</span><span>' + content + '</span></div><p class="info"><span class="time">' + currentdate + '</span></p></div>';
