...
layui.use(['element', 'jquery', 'form', 'layedit'], function() {
	...
	form.on('submit(formLeaveMessage)', function(data) {
		...
		setTimeout(function() {
			...
			var html =
				'<li><div class="comment-parent"><img src="../images/Logo_40.png"alt="模拟留言"/><div class="info"><span class="username">模拟留言</span></div><div class="content">' +
				content +
	...
	form.on('submit(formReply)', function(data) {
		...
		setTimeout(function() {
			...
			var html =
				'<div class="comment-child"><img src="../images/Absolutely.jpg"alt="Absolutely"/><div class="info"><span class="username">模拟回复</span><span>' +
				content + '</span></div><p class="info"><span class="time">2017-03-18 18:26</span></p></div>';
